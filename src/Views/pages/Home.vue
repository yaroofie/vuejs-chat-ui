...
<script>
import Template from "@v/templates/Chat.vue";
import MessageItem from "@v/organisms/lists/MessageItem.vue";
import ChatHeader from "@v/organisms/header/Chat.vue";
import ChatInput from "@v/organisms/footer/ChatInput.vue";
import ImageEditor from "@v/organisms/cards/ImageEditor.vue";
import ChatsMenu from "@v/organisms/cards/ChatsMenu.vue";
import ChatInfo from "@v/organisms/cards/ChatInfo.vue";
import { ChatModel , Chat , Message } from "@m/Chat";
...
export default {
  ...
  methods: {
    ...
    remove(message) {
      this.controller.remove(message);
    },
    addUiData() {
