...
import { useStore } from "@m";
import { useAlert } from "@m/alert";
import { useRequest } from "@m/request";
  ...
  getters: {
    address() {
      return this._address
        ? this.store.api + "user/" + this._address
        : "https://api.lorem.space/image/face?hash=88560";
    },
    api() {
